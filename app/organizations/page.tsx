        ...
        <div>
            <div className="px-9 md:px-22 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <PlayProject target="_self" link="/rules" name="Samsung Knox Manage: Rules" description="A feature in Samsung&rsquo;s EMM solution, Knox Manage, that lets IT admins create various device management rules, which monitor device activity and streamline enterprise mobility management." tag1="UX design" tag2="B2B UX" imageSrc="/rules-sq.png" />
