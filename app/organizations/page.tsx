  ...
  return (
    <div className="flex items-center justify-center flex-col">
        <div className="w-full px-10 md:w-1/3 md:px-0 mt-20">
            ...
            <p className="text-sm text-[var(--colour-body-text-2)] leading-loose mb-6">Categorizing devices based on organizational structure, enabling hierarchical device management.</p>
            ...
            <div>
                ...
                <div className="flex flex-col justify-center bg-[var(--colour-grey)] px-7 md:px-7 py-7 md:py-7 rounded-2xl">
                    ...
                    <p className="text-sm text-[var(--colour-bodytext)] mt-5 leading-loose">Feel free to send me an <span className="inline-block"><Button link="mailto:dht4@sfu.ca" target="_blank" variant="blue-hyperlink" text="email" textSize="text-sm"/></span>!</p>
                </div>
            </div>
            <Footer/>
        </div>
