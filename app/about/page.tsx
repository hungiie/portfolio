    ...
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-1/3 2xl:w-[30%] mt-10">
                ...
                <div className="">
                    <p className="font-light text-sm text-[var(--colour-bodytext)]">Send me an <span className="inline-block"><MyButton link="mailto:d.hungtran12@gmail.com" target="_blank" variant="hyperlink" text="email" textSize="text-sm"/></span>.</p>
                    <p className="font-light text-sm text-[var(--colour-bodytext)]">Send me a message on <span className="inline-block"><MyButton link="https://www.linkedin.com/in/hung-tran-profile/" target="_blank" variant="hyperlink" text="LinkedIn" textSize="text-sm"/></span>.</p>
                    <p className="font-light text-sm text-[var(--colour-bodytext)]">Check out my <span className="inline-block"><MyButton link="https://drive.google.com/file/d/1CrubhoYF0ok5oFfJT3Ffxlkr6Jp0p8Jk/view?usp=sharing" target="_blank" variant="hyperlink" text="resume" textSize="text-sm"/></span>.</p>
                </div>
                ...
                <div className="w-full flex items-center justify-center">
                    <div className="w-full h-auto relative mb-11">
                ...
                {/* <p className="text-lg text-[var(--colour-bodytext)] leading-loose mb-6">My story.</p> */}
