...
export default function About() {
  return (
    <div className="flex items-center justify-center flex-col">
        ...
        <div className="w-full px-10 md:w-2/3 lg:w-1/3 lg:px-0 2xl:w-1/4 mt-28">
            <div className="mb-10">
            ...
            <div className="w-full flex items-center justify-center">
                <div className="w-full h-auto relative mb-10 overflow-hidden">
                    <Image src="/mememe-darkmode.png" width={2316} height={1276} alt="hung tran" className="object-cover block dark:hidden" style={{ filter: 'contrast(89%) brightness(100%)' }}/>
