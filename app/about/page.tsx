        ...
        <div className="mt-15 px-9 md:mt-30 md:px-22">
            <div className="grid grid-cols-1 md:grid-cols-[1.3fr_1fr]">
                <div className="order-2 md:order-1">
                    ...
                    <p className="text-4xl md:text-7xl text-[var(--colour-bodytext)] font-semibold tracking-[-0.15rem] leading-[120%] md:leading-[110%] mb-9">I&apos;m a product designer with occasional GitHub contributions.</p>
