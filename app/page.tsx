    ...
    <div className="flex items-center justify-center">
      <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-1/3 2xl:w-1/4 mt-28">
        ...
        <div className="w-full">
          ...
          <p className="text-sm text-[var(--colour-bodytext)] leading-loose">This portfolio includes both professional and academic work. While my professional work shows real impact, my academic projects show my way to think, explore, and experiment when given space.</p>
          <div className="mb-6"></div>
