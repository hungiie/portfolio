  ...
  return (
    <div className="px-9 md:px-22 grid grid-cols-1 md:grid-cols-[1fr_1.3fr]">
      ...
      <div className="mt-20 md:mt-30 pb-15 md:pb-30">
        ...
        <ProjectThumbnail link="/rules" name="Samsung Knox Manage: Rules management" description="A feature in Samsung&rsquo;s EMM solution, Knox Manage, that lets IT admins create various device management rules, which monitor device activity and streamline enterprise mobility management." tag1="UX design" tag2="8 months" tag3="B2B UX" imageSrc="/rules.png" colourCode="var(--colour-samsung)" />
        ...
        <ProjectThumbnail link="/demo" name="Samsung Knox: Knox Demo Kit" description="Designed an interactive demo kit for Samsung Knox Cloud Service to showcase its key features and unique selling points to enterprise clients." tag1="UX design" tag2="8 months" tag3="B2B UX" imageSrc="/demo.png" colourCode="var(--colour-samsung)" />
