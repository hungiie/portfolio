    ...
    <div className="flex items-center justify-center">
        <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-[85%] 2xl:w-[70%] mt-28">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-25">
              ...
              {/* <SlideUp>
                  <ProjectThumbnail2 isLink="image-link" link="visuals" name="Visual design" desc="I like to play around with graphic design, motion, and visual design. Here's the damage." imageSrc="/visuall.png" imageSrcDark="/memorymate-hover.png" target="_self"/>
              </SlideUp> */}
              {/* <SlideUp>
