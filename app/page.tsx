    ...
    <div className="flex items-center justify-center">
      <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-1/3 2xl:w-1/4 mt-28">
        ...
        <SlideUpDelay>
          ...
          <p className="mb-6 text-sm text-[var(--colour-bodytext)] leading-loose">Each click comes effortlessly, so users can stay focused on their tasks while the interface slowly dissolves into the background of attention.</p>
