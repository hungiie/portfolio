    ...
    <div className="px-9 md:px-22 grid grid-cols-1 md:grid-cols-[1fr_1.3fr]">
      <div className="md:h-screen">
        <div className="mt-35 md:fixed md:-mt-10 md:flex md:flex-col md:justify-center md:h-screen">
          <p className="text-5xl md:text-7xl text-[var(--colour-bodytext)] font-semibold tracking-[-0.15rem] mb-9">Hi, I&apos;m Hung.</p>
      ...
      <div className="mt-20 md:mt-30 pb-15 md:pb-30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7">
          ...
          <OtherProjectThumbnail link="" name="Fraser Health&lsquo;s internship." description="My work as a visual design & videographer intern at Fraser Health Authority from October 2023 to May 2024." tag="Visual design" imageSrc="/fh.png" />
        </div>
      </div>
