  ...
  return (
    <div className="flex items-center justify-center flex-col">
        <div className="w-full px-10 md:w-1/3 md:px-0 mt-20">
            ...
            <p className="text-sm text-[var(--colour-body-text-2)] mb-6">Creating conditional rules to automate management tasks, monitor device activities and set up alert system.</p>
            ...
            <div>
                ...
                <p className="mb-8 text-sm text-[var(--colour-bodytext)]">Tian Jia (Senior UX Designer) and Hosoo Lee (Product Manager)</p>
