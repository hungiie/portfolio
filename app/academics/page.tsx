  ...
  return (
    <div>
        <div>
            ...
            <div className="flex items-center justify-center">
                <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-[75%] 2xl:w-[60%]">
                    <div className="mb-18"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-25">
                        ...
                        <ProjectThumbnail isLink="yes-thumbnail" link="https://www.figma.com/proto/dZnu88TbS026t0KrGb9kzf/Spotify-multi-select-behaviour?page-id=0%3A1&node-id=1-2&viewport=270%2C124%2C0.12&t=PQEKyHPnjQsyzmKD-1&scaling=contain&content-scaling=fixed" name="Spotify's multi-select pattern" desc="A more discoverable, beginner-friendly bulk-select pattern for Spotify Desktop, replacing the selecting + CTRL/CMD on Mac interaction." imageSrc="/spotify.png" imageSrcDark="/spotify.png" target="_blank"/>
                        <ProjectThumbnail isLink="yes-thumbnail" link="https://drive.google.com/file/d/1d0jGR0QJN3mzwX6o9n0C54g6aHej0I9l/view" name="React Native app connecting to APIs and device features" desc="Memory Mate is a note-taking app for senior citizens, integrating APIs such as Apple Maps, Text-to-speech, and Firebase for backend database and user authentication." imageSrc="/memorymate.png" imageSrcDark="/memorymate.png" target="_blank"/>
                        ...
                        <ProjectThumbnail isLink="yes-thumbnail" link="https://www.figma.com/proto/dR8IwrNDcNRTCsmhpNP0Ew/card.io-presentation?page-id=0%3A1&node-id=1-770&viewport=269%2C-68%2C0.19&t=64Rcb8HbgCBw0CuG-1&scaling=contain&content-scaling=fixed" name="Create personalized running playlists with card.io" desc="Designed a Spotify feature that guides runners in creating personalized cardio playlists, helping them feel confident and in control." imageSrc="/cardiohi.png" imageSrcDark="/cardiohi.png" target="_blank"/>
                        ...
                        <ProjectThumbnail isLink="yes-thumbnail" link="https://www.figma.com/proto/GGhP28qi8xj1jJ6asd7LkQ/Uber-Eats-Nutritious-report?page-id=0%3A1&node-id=1-32&viewport=-626%2C53%2C0.16&t=SrEinkNHzqykjbkn-1&scaling=scale-down&content-scaling=fixed" name="Tracking nutrition for frequent Uber Eats users" desc="Uber Eats feature that assists and informs regular users about their food&rsquo;s nutrition details, makes sure specified dietary needs are met." imageSrc="/ubereats.png" imageSrcDark="/ubereats.png" target="_blank"/>
                    </div>
