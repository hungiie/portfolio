  ...
  return (
    <div className="flex items-center justify-center flex-col">
        <div className="w-full px-10 md:w-1/3 md:px-0 mt-20">
            ...
            <p className="text-sm text-[var(--colour-body-text-2)] leading-loose mb-6">Interactive demo for Samsung Knox services, highlighting its key features and unique selling points for enterprise clients.</p>
