        ...
        <div className={`px-13 py-13 rounded-2xl bg-[var(--colour-grey)] mt-7 ${props.visibility}`}>
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-x-20`}>
                <div className="">
                    ...
                    <p className="text-md text-[var(--colour-bodytext)] w-full mb-2">I selectively recruited 3 new international students at SFU as participants for this user testing to ensure our insights reflect the app's primary target audience.</p>
                ...
                <div className="">
                    ...
                    <p className="text-md text-[var(--colour-bodytext)] w-full mb-2">2) How effectively do users utilize the app's AI features, and how well do these features enhance their experience?</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-5 gap-y-5 mb-5">
                <div className="bg-[var(--background)] px-10 py-10 rounded-2xl">
                    ...
                    <p className="text-xl text-[var(--colour-bodytext)] font-semibold mb-8">Difficulty navigating through the site or app, stuck in some areas like the "Join Group" or messages.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-5">
                ...
                <div className="bg-[var(--background)] px-10 py-10 rounded-2xl">
                    ...
                    <p className="text-xl text-[var(--colour-bodytext)] font-semibold mb-8">Fail to fully utilize AI's feature due to unclear visual indicators.</p>
