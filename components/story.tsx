      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
            className="absolute -top-10 text-sm text-[var(--colour-bodytext)] leading-loose origin-center z-10"
          >
            View Hung's story :)
          </motion.p>
          ...
          <div
            className={`
              w-[65%] 2xl:w-[65%] aspect-square rounded-full overflow-hidden 
              border-4 p-1 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-[var(--main-blue)]
