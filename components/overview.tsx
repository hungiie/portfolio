    ...
    return(
        <div className="mt-15">
            ...
            <div className="grid grid-cols-2 w-4/5 md:w-1/4">
                ...
                <p className="text-[var(--colour-bodytext-3)] text-md">{props.value2}</p>
                <p className="text-[var(--colour-bodytext)] text-md">{props.subject3}</p>
                <p className="text-[var(--colour-bodytext-3)] text-md">{props.value3}</p>
            </div>
        </div>
    )
}