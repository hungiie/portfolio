...
export default function PlayProject(props: Props) {
    return(
        <a href={props.link} target={props.target} className="group mb-4 rounded-2xl border-[#efefef] border-2 overflow-hidden grid grid-cols-1 md:grid-cols-[1fr_2fr] cursor-pointer">
