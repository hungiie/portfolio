...
export default function MyNav(props: Props) {
  ...
  const baseNavClasses =
    "w-full bg-[var(--nav-bg)] backdrop-blur-lg border-b-[0.75px] border-[var(--nav-border)] fixed z-20 h-14 flex justify-center top-0 transition-transform duration-800";
