    ...
    return(
        <a href={props.link} className="group mb-8 block rounded-2xl border-[#e7e7e7] border-2 overflow-hidden">
            <div className="w-full relative overflow-hidden">
                ...
                <Image src={props.image2Src} alt={props.name} width={2469} height={861} className="absolute inset-0 object-cover mt-100 group-hover:mt-0 duration-600 ease-in-out" />
            </div>
